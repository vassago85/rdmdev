...
<section class="bg-brand-600 text-white">
    <div class="container py-14 lg:py-16 grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-center">
        <div>
            <p class="eyebrow !text-brand-100">Let's talk</p>
            <h2 class="!text-white mt-2">{{ $heading }}</h2>
            <p class="mt-4 text-brand-50 max-w-xl text-lg leading-relaxed">{{ $subtext }}</p>
        </div>
