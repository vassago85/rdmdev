@props(['name' => 'circle', 'stroke' => '2'])

@php
    // Lucide icon paths (https://lucide.dev) — hand-inlined so we don't ship a
    // runtime icon library. Keep stroke-width / stroke-linecap / stroke-linejoin
    // consistent across the whole site.
    $icons = [
        'phone'           => '<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.37 1.89.72 2.78a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.11-.45c.89.35 1.82.59 2.78.72A2 2 0 0 1 22 16.92z"/>',
    ...
    $path = $icons[$name] ?? $icons['check-circle-2'];
@endphp
